...
# The port is vendored at src/ap101Utils/sdfpkg.py (see its provenance note).
sys.path.insert(0, os.path.join(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "src"))

from ap101Utils.sdfpkg import (  # noqa: E402
    SdfContext, SdfError,
...
def t20_strerror():
    ...
    from ap101Utils.sdfpkg import _strerror
